          ...
          <div style={{ background: '#EF9F2710', border: '0.5px solid #EF9F2740', borderRadius: '12px', padding: '18px', marginBottom: '20px' }}>
            ...
            {pending.map(u => (
              <div key={u.id} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '10px 0', borderBottom: '0.5px solid #EF9F2720' }}>
                ...
                <button onClick={() => approveUser(u.id)} style={{ background: '#1D9E7522', border: '0.5px solid #1D9E7555', borderRadius: '8px', color: '#5DCAA5', fontSize: '12px', fontWeight: 600, padding: '6px 14px', cursor: 'pointer', fontFamily: 'inherit' }}>
                  ✓ Approuver
                </button>
                <button onClick={() => rejectUser(u.id)} style={{ background: '#A32D2D1a', border: '0.5px solid #A32D2D40', borderRadius: '8px', color: '#E24B4A', fontSize: '12px', fontWeight: 600, padding: '6px 14px', cursor: 'pointer', fontFamily: 'inherit' }}>
                  ✗ Refuser
                </button>
              </div>
            ))}
                  ...
                  <tr key={u.id}>
                    ...
                    <td>
                      <span style={{
                        ...
                        background: u.status === 'approved' ? '#1D9E7515' : u.status === 'pending' ? '#EF9F2715' : '#E24B4A15',
                        color: u.status === 'approved' ? '#1D9E75' : u.status === 'pending' ? '#EF9F27' : '#E24B4A'
                      }}>
                    ...
                    <td>
                      <select
                        ...
                        style={{ background: '#0f1117', border: '0.5px solid #2e2e4a', borderRadius: '8px', padding: '7px 12px', color: '#e2e0f0', fontSize: '13px', fontFamily: 'inherit', outline: 'none', cursor: 'pointer' }}
                      >
